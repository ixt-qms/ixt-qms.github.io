...
function V4AuditSim({ lang }) {
  ...
  const t = lang === 'es' ? {
    ...
    items: [
      ...
      { clause: '8.1', q: '¿Cómo controlan la especificación vigente de cada parte de su cliente?', a: 'BOM de cliente: jerarquía cliente-proyecto-parte con la especificación confirmada que se usa para inspeccionar.' },
      ...
      { clause: '7.2', q: '¿Cómo dan seguimiento al desarrollo y capacitación de su personal en el tiempo, y cómo evaluan que fue efectiva?', a: 'Skills & Training: curva de desarrollo por evaluación, cursos registrados por persona y nivel real alcanzado — no solo asistencia.' },
      ...
      { clause: '8.2.3', q: '¿Cómo controlan la confirmación de especificaciones por parte y por cliente?', a: 'Confirmación de especificaciones: catálogo de specs por parte y cliente con tolerancias, y evidencia fotográfica OK/NOK de cada inspección.' },
    ],
    ...
    items: [
      ...
      { clause: '8.1', q: 'How do you control the current specification for each of your customer parts?', a: 'Customer BOM: client-project-part hierarchy with the confirmed specification used to inspect.' },
      ...
      { clause: '7.2', q: 'How do you track your staff’s development and training over time, and how do you evaluate that it was effective?', a: 'Skills & Training: development curve per evaluation, courses logged per person and actual level reached — not just attendance.' },
      ...
      { clause: '8.2.3', q: 'How do you control specification confirmation by part and by customer?', a: 'Spec confirmation: spec catalog by part and customer with tolerances, and OK/NOK photo evidence for every inspection.' },
    ],
